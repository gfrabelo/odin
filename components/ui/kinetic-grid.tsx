...
const CELL_SIZE = 50; // Grid density
const INFLUENCE_RADIUS = 280;
const MAX_WARP = 28;
const DOT_SPACING = 28;
const LERP_SPEED = 0.08;

const LINE_BASE = { r: 56, g: 189, b: 248, a: 0.28 }; // Cyan base glow
    ...
    (
      ...
      for (const r of ripples) {
        ...
        if (Math.abs(diff) < waveWidth) {
          const strength =
            (1 - Math.abs(diff) / waveWidth) * r.opacity * 22 * pinFactor;
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        default: {
          bg: "#0a0e27",
          lineActive: { r: 56, g: 189, b: 248, a: 1.0 },
        ...
        monochrome: {
          bg: "#000000",
          lineActive: { r: 255, g: 255, b: 255, a: 0.95 },
      ...
      // Static background dot texture (cyan-tinged)
      ...
      for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
          ...
          if (t > 0.2) {
            const glowR = r + lerpN(0, 8, (t - 0.2) / 0.8);
